...
|:---|:---:|:---:|
| Signature | | |
| Print Name | ${placeholder(data.party1Name, "_______________")} | ${placeholder(data.party2Name, "_______________")} |
| Title | ${placeholder(data.party1Title, "_______________")} | ${placeholder(data.party2Title, "_______________")} |
| Company | ${placeholder(data.party1Company, "_______________")} | ${placeholder(data.party2Company, "_______________")} |
| Notice Address | ${placeholder(data.party1Address, "_______________")} | ${placeholder(data.party2Address, "_______________")} |
| Date | | |
...
// Derived from STANDARD_TERMS_SECTIONS — single source of truth
export const STANDARD_TERMS =
  `# Standard Terms\n\n` +
  STANDARD_TERMS_SECTIONS.map(
    (s) => `${s.num}. **${s.title}**. ${s.text}`,
  ).join("\n\n") +
  `\n\n*Common Paper Mutual Non-Disclosure Agreement Version 1.0 free to use under CC BY 4.0.*`;
